...
-  ### Landing page Main Image 
   ...
   - The landing area includes a photo and a text overlay that together clearly identify the purpose of the business and the type of products it sells. The button below links to the "about us" section. It changes the color of the fonts when the mouse hovers over it. It is responsive on multiple screen sizes. 
...
This section can either be viewed by scrolling down the page to the next section below the main section or by clicking the "About us" link on the navigation bar. This section features a symbol team photo and gives the user a short summary of the companys history, roots and information of the range of products and services. 
...
- The Contact page provides the user with an interactive google map showing the location of the company along with details on full address, phone number and email address. By clicking the 'View larger map' link the user can go to the google maps site for the address - this opens in a separate tab to allow ease of navigation.
...
The footer section contains clickable links to the social media accounts like facebook, twitter and instagram. Also the copyright information is placed there.
...
### Images: 
  + The logo was provided to me from my employer.
  + The landing page main image is a personal photo provided by my work colleague
  + The team symbol photo was taken from pexels
  
### Color Scheme: 
  + The colours picked were inspired by a palette from [Lily Bug Design](https://www.lilybugdesign.co.nz/colour-wall)

  ![Colour Palette](documentation/supp-images/.png)

### Typography
    -   Google Fonts were used to import x and x fonts into styles.css.  These were chosen as they work well together and have a simple, modern feel that is easy to read.
...
+ VScode Studio was used to write and edit the code and host the site on my local computer
...
-   [Google Fonts:](https://fonts.google.com/) was used to import the 'x' and 'x' fonts into the style.css file which are used on all pages of the project.
-   [Font Awesome:](https://fontawesome.com/) was used to add icons for aesthetic and UX purposes.
-   [Wireframe](https://Wireframe link/) was used to create the wireframe during the design process.
